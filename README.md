...
- <a href="https://github.com/Taeseo06/Free-RallingMotion_Python">물리운동 시뮬레이터 (2023.4 ~ <span style="color:#ffd33d"> 현재 개발중 </span> )</a> - 물리1에서 배우는 자유낙하 운동, 수평으로 던진 물체의 운동 등 다양한 운동 시뮬레이터를 파이썬 tkinter로 구현 (gui) 
